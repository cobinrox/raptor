...
sudo java -cp .:./io/target:./io/target/classes:./common/target/classes:$libusb4j:$usb4j:$logjar:$jsonjar:$pi4jjar:./io/target/rap_io.jar com.cobinrox.io.DoMotorCmd saberwc.properties
